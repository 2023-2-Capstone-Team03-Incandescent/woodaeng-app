...
class Profile_Settings_Account_ChangePW extends StatelessWidget {
  Profile_Settings_Account_ChangePW({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 71.0, start: 19.0),
            Pin(size: 15.0, middle: 0.2272),
            child: Text(
              '현재 비밀번호',
              style: TextStyle(
                fontFamily: 'TmoneyRoundWindRegular',
