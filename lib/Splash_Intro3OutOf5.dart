...
import 'package:did_u_c_my_dog/Splash_Intro4OutOf5.dart';
import 'package:flutter/material.dart';
import 'package:adobe_xd/pinned.dart';

class Splash_Intro3OutOf5 extends StatelessWidget {
  Splash_Intro3OutOf5({
    Key? key,
  }) : super(key: key);
        ...
        children: <Widget>[
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(
                      'assets/images/AppIntro_Game3.gif'),
                  fit: BoxFit.fill,
                ),
          ...
          Pinned.fromPins(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  pageBuilder: () => Splash_Intro4OutOf5(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
